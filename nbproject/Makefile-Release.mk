...
${OBJECTDIR}/src/BoardColumn.o: src/BoardColumn.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/BoardColumn.o src/BoardColumn.cpp

${OBJECTDIR}/src/Checker.o: src/Checker.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Checker.o src/Checker.cpp
...
${OBJECTDIR}/Include/Bitmap.o: Include/Bitmap.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Include/Bitmap.o Include/Bitmap.cpp

${OBJECTDIR}/Include/Game.o: Include/Game.cpp 
	${MKDIR} -p ${OBJECTDIR}/Include
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Include/Game.o Include/Game.cpp

${OBJECTDIR}/src/StatusBar.o: src/StatusBar.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/StatusBar.o src/StatusBar.cpp
